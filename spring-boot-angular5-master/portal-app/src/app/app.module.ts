...
import { TrainercurrentService } from './trainercurrent/trainercurrent.service';
...
@NgModule({
  ...
  providers: [UserService, SigninService, StartpageService, 
      SignupService, AdminService, PaymentService,TrainercurrentService, 
      TrainercompletedService, TraineridService, LoginService, 
      UsermenuService, TrainerhomeService, UseridService, 
      CompletedService, HomeService, AdminloginService, SignupmentorService, 
      MentorService, TechnologyService, SkillService, TrainingService, PageService, SignuppageService],
